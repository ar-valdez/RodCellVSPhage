...
int UpdateEnvArray(Array3D<LocalEnv>* CurrentColony, Array3D<LocalEnv>* PreviousColony, \
                   Array3D<LocalAga>** CurrentAgar, Array3D<LocalAga>** PreviousAgar, \
                   Array2D<LocalAga>** CurrentWall, Array2D<LocalAga>** PreviousWall, \
                   Array3D<double>& DensityShiftP, Array3D<double>& Density1ShiftP, \
                   Array3D<double>& Density2ShiftP, Array2D<double>& WallDensityShiftP, \
                   Array2D<double>& WallDensity1ShiftP, Array2D<double>& WallDensity2ShiftP, \
                   int minX, int maxX, int minY, int maxY, int maxH, Array2D<double>& Height, \
...
void UpdateEnvironment(Array3D<LocalEnv>* Env, Array3D<LocalEnv>* prevEnv, Array2D<LocalAga>* prevWal, \
                       Array3D<double>& DensityShiftP, Array3D<double>& Density1ShiftP, \
                       Array3D<double>& Density2ShiftP,Array2D<double>& WallDensityShiftP, \
                       IntCoord position, Array3D<double>& insideColonyDen)
{
...
void UpdateWall(Array3D<LocalEnv>* Env, Array3D<LocalAga>** prevAga, Array2D<LocalAga>** Wal, \
                Array2D<LocalAga>** prevWal, Array2D<double>& WallDensityShiftP, \
                Array2D<double>& WallDensity1ShiftP, Array2D<double>& WallDensity2ShiftP, \
                IntCoord2D position, int level, Array2D<double>& Height, Array3D<double>& insideColonyDen)
{
    ...
    if (level==0 && insideColonyDen.Get(positionWall3D)>0.5) //(level==0 && WallDensityShiftP.Get(position) > 0.8 && Height.At(position) > cellRadius+1e-7)
    {
        ...
        switch (InterfaceCondition)
        {
            ...
            default:
            {
                std::cout << "Wrong switch on interface condition!" << std::endl;
            }
        }
    }
    else
